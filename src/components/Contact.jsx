...
import { FaWhatsapp, MdOutlineMailOutline,IoLogoGithub, FaLinkedin, FaInstagram } from "../logos";
  ...
  return (
    <section id="contact">
      <div className="bg-secondary py-7">
        ...
        <div className="flex flex-col items-center justify-center my-3 xs:flex-row">
          ...
          >
            ...
            <p className="font-poppins ml-1 mr-10 xs:mr-0 text-lg">+923449159941</p>
          </a>
          <a 
        ...
        <div className="flex justify-center items-center my-2 mt-8">
          ...
          <a 
            href="https://github.com/rabiuddin"
            target="_blank"
          >
      ...
      <div className="bg-secondary">
          <p className="text-center font-poppins uppercase text-primary">© 2024 Muhammad Rabi Uddin. All Rights Reserved.</p>  
        </div>
    </section>
  );
};
